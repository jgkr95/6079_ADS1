...
class Merge {
     ...
     */
    public static void swap(Comparable[] aux, int i, int j) {
     ...
     */
    public static boolean isSorted(Comparable[] aux) {
     ...
     * @return     True if sorted, False otherwise.
     */
    public static boolean isSorted(Comparable[] aux, int lo, int hi) {
     ...
     */
    public static Object show(Object[] aux) {
        String s = "[";
        int i;
